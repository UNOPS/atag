...
internal class TaggedEntityMap : IEntityTypeConfiguration<TaggedEntity>
{
	...
	public void Configure(EntityTypeBuilder<TaggedEntity> entity)
	{
		...
		entity.HasIndex(t => new { t.EntityType, t.EntityKey, t.TagId }).HasDatabaseName("IX_TaggedEntity_EntityType_EntityKey_TagId");
	}
}